...
from ..utils import (get_spider_config,get_spider_rule,
...
class TemplatedreiSpider(CrawlSpider):
    ...
    def __init__(self,*args,**kwargs):
        ...
        #params 6/interact 2
        self.rules = get_spider_rule(self.name,self.logger)
        ...
        if success:
            set_start_action(self._name,self.logger,
                self.user,self.ip,action,result)
        else:
            set_error_action(self._name,self.logger,
                self.user,self.ip,action,result)
